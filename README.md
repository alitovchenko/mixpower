...
`mp_report()` turns a result into a Markdown trust report — design, assumptions,
calibration, power with interval and Monte Carlo precision, diagnostics,
reproducibility manifest, and explicit caveats about fragile claims — ready to
drop into a methods section, grant, or registered report:
